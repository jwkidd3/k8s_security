...
```bash
kubectl apply -f labs/lab-08/require-labels-clusterpolicy.yaml
...
kubectl apply -f labs/lab-08/labeled-pod.yaml
...
```bash
kubectl apply -f labs/lab-08/disallow-latest-tag-clusterpolicy.yaml

# Test: latest tag (should FAIL)
kubectl apply -f labs/lab-08/latest-tag-pod.yaml
echo "Expected: Blocked - latest tag not allowed"

# Test: specific tag (should SUCCEED)
kubectl apply -f labs/lab-08/versioned-pod.yaml
echo "Expected: Created successfully"
```
...
```bash
kubectl apply -f labs/lab-08/add-default-securitycontext-clusterpolicy.yaml
...
kubectl apply -f labs/lab-08/mutated-pod.yaml
...
```bash
kubectl apply -f labs/lab-08/generate-default-networkpolicy-clusterpolicy.yaml
